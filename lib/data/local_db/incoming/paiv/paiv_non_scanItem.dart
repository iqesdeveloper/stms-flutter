...
class DBPaivNonItem {
  ...
  // Delete selected PaivNonItem
  Future<int> deletePaivNonItem(String itemInvID) async {
    final db = await database;
    final res = await db.rawDelete('DELETE FROM paivNonItem WHERE item_inventory_id == ?',
        [itemInvID]);
