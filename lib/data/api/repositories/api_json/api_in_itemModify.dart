...
class ItemModifyService {
  Future<dynamic> sendToServer(var uploadData) async {
    ...
    var getdata = prefs.getString('saveIM');
    var imData = json.decode(getdata!) as Map<String, dynamic>;
    ...
    String url =
        ServerAddressesProd.serverAddress + ServerAddressesProd.imTransaction;

    var queryParameters = {
      'token': Storage().token,
    };
    Map data = {
      "transaction_type": imData['transaction_type'],
      "im_date": imData['im_date'],
